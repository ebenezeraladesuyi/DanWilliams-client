  ...
  return (
    <div className="w-full flex gap-3 md:gap-4 lg:gap-7 items-center justify-center">
        <div className="w-[21%] md:w-[15%] h-[80px] md:h-[110px] border-[1px] rounded border-white flex flex-col justify-center items-center gap-2 text-white lg:w-[12%] lg:h-[120px]">
            ...
            <h5 className="font-semibold text-[8px] md:text-[14px] lg:text-[17px]">DAY</h5>
        </div>
        ...
        <div className="w-[21%] md:w-[15%] h-[80px] md:h-[110px] border-[1px] rounded border-white flex flex-col justify-center items-center gap-2 text-white lg:w-[12%] lg:h-[120px]">
            ...
            <hr className="w-full border-[1px] border-white"/>
            <h5 className="font-semibold text-[8px] md:text-[14px] lg:text-[17px]">HOURS</h5>
        </div>
        ...
        <div className="w-[21%] md:w-[15%] h-[80px] md:h-[110px] border-[1px] rounded border-white flex flex-col justify-center items-center gap-2 text-white lg:w-[12%] lg:h-[120px]">
            ...
            <hr className="w-full border-[1px] border-white"/>
            <h5 className="font-semibold text-[8px] md:text-[14px] lg:text-[17px]">MINUTES</h5>
        </div>
        ...
        <div className="w-[21%] md:w-[15%] h-[80px] md:h-[110px] border-[1px] rounded border-white flex flex-col justify-center items-center gap-2 text-white lg:w-[12%] lg:h-[120px]">
            ...
            <hr className="w-full border-[1px] border-white"/>
            <h5 className="font-semibold text-[8px] md:text-[14px] lg:text-[17px]">SECONDS</h5>
        </div>
    </div>
  );
};
