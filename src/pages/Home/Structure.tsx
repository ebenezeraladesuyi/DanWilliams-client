  ...
  return (
    <div className="w-full h-[100%] py-[50px] flex items-center justify-center font-pop overflow-hidden bg-black">
        <div className="w-[90%] flex flex-col md:flex-row justify-between items-center gap-4">
            <h4 className="text-white text-[20px] md:text-[30px] lg:text-[35px] font-bold md:w-[60%] text-center md:text-left"><span className="flex items-center justify-center md:justify-start mb-[10px]"><FaBuildingColumns /></span>We would like to help you decide <span className="text-orange-500">what structure suits you.</span></h4>
