...
import { iCac } from "../../types/Interface";
...
const CacReg = () => {
    ...
    const [formData, setFormData] = React.useState<iCac>({
        fullName: "",
        email: "",
        phoneNumber: "",
        // skill: "",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true)
        try {
            const forexData = await axios.post(`${url}/cac/registercac`, formData)
